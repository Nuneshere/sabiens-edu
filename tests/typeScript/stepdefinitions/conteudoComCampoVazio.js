...
cucumber_1.defineSupportCode(function ({ Given, When, Then, setDefaultTimeout }) {
    ...
    Given(/^Adiciono na lista de conteudo, o conteudo com titulo de "([^\"]*)" , descricao de "([^\"]*)" , introducao de "([^\"]*)" , desenvolvimento com titulo de "([^\"]*)" e descricao "([^\"]*)" e por fim, e deixou em branco o campo de conclusao$/, (titulo, descriConteudo, intro, nomeTopico, descriTopico) => __awaiter(this, void 0, void 0, function* () {
