...
cucumber_1.defineSupportCode(function ({ Given, When, Then, setDefaultTimeout }) {
    ...
    Given(/^Adiciono na lista de conteudo o conteudo com seguinte titulo "([^\"]*)" , descricao de "([^\"]*)" , introducao de "([^\"]*)" , desenvolvimento com titulo de "([^\"]*)" e descricao "([^\"]*)" e por fim, conclusao com "([^\"]*)"$/, (titulo, descriConteudo, intro, nomeTopico, descriTopico, concl) => __awaiter(this, void 0, void 0, function* () {
        //await expect(browser.getTitle()).to.eventually.equal('Adicionar conteudo');//checa se está
        yield protractor_1.$("input[name='titulo']").sendKeys(titulo); //Adicionando o conteudo na lista
        yield protractor_1.$("input[name='descricao']").sendKeys(descriConteudo);
        yield protractor_1.$("textarea[name='introducao']").sendKeys(intro);
    ...
    When(/^Eu tento inserir o conteudo$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.$("a[name='send']").click();
    }));
    Then(/^Uma mensagem de erro em forma de alert com o texto "([^\"]*)" aparece na tela$/, (alertMes) => __awaiter(this, void 0, void 0, function* () {
